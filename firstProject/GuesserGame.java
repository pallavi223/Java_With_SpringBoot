	 ...
	 //method to collect a number from players
	   ...
	   public void compare() 
	   {
		if(numFromGuesser == numFromPlayer1) 
		 {
			...
			else if(numFromGuesser == numFromPlayer3) 
			{
	   	   ...
	   	   {
	   		System.out.println("OOhhOO!, Player1 Number is Correct. You Win the Game!!!");
		...
		else if(numFromGuesser == numFromPlayer2) 
		{
		   ...
		   {
			      System.out.println("OOhhOO!, Player2 Number is Correct. You Win the Game!!!");
		    }
	   }
		...
		{
			 System.out.println("OOhhOO!, Player3 Number is Correct. You Win the Game!!!");
